...
// guarda en memoria el valor inicial
const old = props.cantidad;

const agregarGasto = () => {
  // Validar que no haya campos vacios
  const { cantidad, categoria, nombre, id, disponible } = props;
  ...
  // en caso sea edición
    ...
    // tomar en cuenta el gasto antes realizado
    if (cantidad > old + disponible) {
      error.value = "Has excedido el presupuesto";
    }
  }
  // en caso sea un registro nuevo
